  ...
  if (config === true) {
    ...
    if (typeof val_1 === 'string') {
      if (val_1.endsWith('px')) {
        val_1 = parseFloat(val_1); //TODO: build-time
...
var getStyleAndFilteredProps = function (_a) {
  ...
  if (responsiveStyles) {
    if (getResponsiveStyles) {
      ...
      styleFromProps = __assign(__assign({}, styleFromProps), styleFromQuery); //TODO: build-time
...
var resolvePropsToStyle = function (styledSystemProps, theme, platform, debug, currentBreakpoint, strictMode, getResponsiveStyles, INTERNAL_themeStyle, stateProps) {
  ...
  var modifiedStyledSytemProps = __assign({
    fontSize: fontSize
  }, styledSystemProps);
  ...
  var mergedStyle = merge__default["default"].apply({}, [merge__default["default"].apply({}, INTERNAL_themeStyle), styleFromProps, merge__default["default"].apply({}, stateProps === null || stateProps === void 0 ? void 0 : stateProps.INTERNAL_themeStyle), inlineStyleFromProps]);
  return {
    style: mergedStyle,
    styleFromProps: styleFromProps,
